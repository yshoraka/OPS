...
void ops_par_loop_initialise_chunk_kernel_zero(char const *, ops_block, int,
                                               int *, ops_arg);
...
void ops_par_loop_initialise_chunk_kernel_zero_x(char const *, ops_block, int,
                                                 int *, ops_arg);

void ops_par_loop_initialise_chunk_kernel_zero_y(char const *, ops_block, int,
                                                 int *, ops_arg);
